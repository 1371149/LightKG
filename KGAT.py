...
class KGAT(KnowledgeRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.A_in = (
            self.init_graph()
        )  # init the attention matrix by the structure of ckg ,这是一张完整的，包含interaction和kg的图
    ...
    def forward(self):
        ego_embeddings = self._get_ego_embeddings()   #貌似就是把user和entity的embedding层合一起
